...
Everything Cosmian does is **source available** or even open source in this repository - check the license.
...
[Check out](https://github.com/Cosmian/kms) a highly scalable, KMIP compliant Key Management Server written in Rust. Projet under Business License BUSL-1.1.
